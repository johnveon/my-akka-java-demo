package com.example.my.akka.java.demo.agent;

/**
 * @Description: actor
 * @Author: zhoufengen
 * @Create At: 2019-12-18 11:20
 **/
import akka.actor.*;
 ...
 */
public class AgentTestActor extends UntypedActor {
    ...
    public static void main(String [] args) throws InterruptedException, TimeoutException {
        ...
        for(int i = 0 ; i < 10 ; i ++){
            actorRefs[i] = system.actorOf(Props.create(AgentTestActor.class), "AgentTestActor" + i);
        }
        ...
        Futures.sequence(queue, system.dispatcher()).onComplete(new OnComplete<Iterable<Integer>>() {
            ...
            public void onComplete(Throwable throwable, Iterable<Integer> integers) throws Throwable {
                System.out.println("final countAgent 3:" + countAgent.get());
                system.shutdown();
            }
        }, system.dispatcher());
