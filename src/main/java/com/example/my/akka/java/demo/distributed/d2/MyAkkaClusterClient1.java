...
public class MyAkkaClusterClient1 extends UntypedActor {
    ...
    public static void main(String [] args){
        System.out.println("Start myAkkaClusterClient1");
        ActorSystem actorSystem = ActorSystem.create("akkaClusterTest", ConfigFactory.load("reference-client-1.conf"));
        final ActorRef myAkkaClusterClient = actorSystem.actorOf(Props.create(MyAkkaClusterClient1.class), "myAkkaClusterClient");
        System.out.println("Started myAkkaClusterClient1");
