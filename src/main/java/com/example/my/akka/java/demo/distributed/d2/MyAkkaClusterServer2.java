...
public class MyAkkaClusterServer2 extends UntypedActor {
    ...
    public static void main(String [] args){
        System.out.println("Start MyAkkaClusterServer2");
        ActorSystem system = ActorSystem.create("akkaClusterTest", ConfigFactory.load("reference-server-2.conf"));
        system.actorOf(Props.create(MyAkkaClusterServer2.class), "myAkkaClusterServer2");
        System.out.println("Started MyAkkaClusterServer2");
