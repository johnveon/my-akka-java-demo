...
public class MyAkkaClusterServer3 extends UntypedActor {
    ...
    public static void main(String [] args){
        System.out.println("Start MyAkkaClusterServer3");
        ActorSystem system = ActorSystem.create("akkaClusterTest", ConfigFactory.load("reference-server-3.conf"));
        system.actorOf(Props.create(MyAkkaClusterServer3.class), "myAkkaClusterServer3");
        System.out.println("Started MyAkkaClusterServer3");
