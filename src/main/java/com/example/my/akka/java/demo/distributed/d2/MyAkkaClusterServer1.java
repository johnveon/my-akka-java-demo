...
public class MyAkkaClusterServer1 extends UntypedActor {
    ...
    public void onReceive(Object message) {
        if (message instanceof TransformationMessages.TransformationJob) {
            ...
            logger.info("server onReceive=" + job.getText());
    ...
    public static void main(String [] args){
        System.out.println("Start MyAkkaClusterServer1");
        ActorSystem system = ActorSystem.create("akkaClusterTest", ConfigFactory.load("reference-server-1.conf"));
        system.actorOf(Props.create(MyAkkaClusterServer1.class), "myAkkaClusterServer1");
        System.out.println("Started MyAkkaClusterServer1");
